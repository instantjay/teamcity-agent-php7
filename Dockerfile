...
RUN add-apt-repository ppa:ondrej/php && apt update && apt install pkg-config php7.3-dev php7.3-cli php7.3-curl php7.3-xml php7.3-sqlite3 php7.3-mbstring php7.3-gd php-pear tzdata -y && pecl install imagick mcrypt
